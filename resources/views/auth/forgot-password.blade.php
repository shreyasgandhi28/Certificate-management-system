                ...
                <div class="flex min-h-[600px]">
                    ...
                    <div class="brand-panel hidden lg:flex lg:w-1/2 p-12 flex-col justify-center text-white relative">
                        <div class="relative z-10">
                            ...
                            <p class="text-blue-100 text-xl leading-relaxed opacity-90 mb-8">
                                Enter your email address and we'll email you a password reset link that will allow you to choose a new one.
                            </p>
                        </div>
                    ...
                    <div class="w-full lg:w-1/2 p-8 lg:px-12 lg:py-8 flex items-center justify-center">
                        <div class="w-full max-w-sm">
                            ...
                            <div class="lg:hidden text-center mb-10">
                                ...
                                <p class="text-secondary text-base leading-relaxed mb-8">Enter your email to receive a password reset link</p>
                            </div>
                                ...
                                <div class="space-y-5">
                                    <div class="form-group">
                                        ...
                                        <input 
                                            ...
                                            required 
                                            autofocus
                                            class="form-input w-full @error('email') border-red-300 dark:border-red-500 @enderror"
